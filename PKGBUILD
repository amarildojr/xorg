...
source=(${url}/releases/individual/xserver/${pkgbase}-${pkgver}.tar.bz2{,.sig}
        xvfb-run
        xvfb-run.1
        "https://raw.githubusercontent.com/amarildojr/xorg/master/fix.patch")
...
sha256sums=('278459b2c31d61a15655d95a72fb79930c480a6bb8cf9226e48a07df8b1d31c8'
            ...
            'bddfee329ec7fb519dde6015dc502bc503248a3d4d2543730a0ba56aafc919c6')
            
prepare() {
  cd "${srcdir}/${pkgbase}-${pkgver}"
  
  # Add Counter Strike fix patch
  patch -Np1 --ignore-whitespace -i "${srcdir}/fix.patch"
